            ...
            {(close) => (
              <div className="choose-avatar-container">
                ...
                <img
                  ...
                  id="3"
                  className="choose-profile-avatar"
                  src={`http://localhost:5000/images/hacker.png`}
                ></img>
                <img
                  onClick={(e) => {
                    close();
                  ...
                  id="4"
                  className="choose-profile-avatar"
                  src={`http://localhost:5000/images/man.png`}
                ></img>
                <img
                  onClick={(e) => {
                    close();
                  ...
                  id="5"
                  className="choose-profile-avatar"
                  src={`http://localhost:5000/images/man (2).png`}
                ></img>
                <img
                  onClick={(e) => {
                    close();
                  ...
                  id="6"
                  className="choose-profile-avatar"
                  src={`http://localhost:5000/images/man (1).png`}
                ></img>
                <img
                  onClick={(e) => {
                    close();
                  ...
                  id="7"
                  className="choose-profile-avatar"
                  src={`http://localhost:5000/images/woman.png`}
                ></img>
                <img
                  onClick={(e) => {
                    close();
